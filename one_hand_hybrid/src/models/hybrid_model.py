...
def make_model(cfg,num_onehand=106):
    m=cfg["model"];return HybridHandModel(m["num_classes"],num_onehand,m["d_model"],m["encoder_layers"],m["attention_heads"],m["ffn_dim"],m["conv_kernel_size"],m["dropout"],m["embedding_dim"],cfg["features"]["max_len"])
